...
(function initI18n() {
  ...
  const translations = {
    en: {
      ...
      heroSubtitle: 'Customer Success Manager\nProcess Optimization',
      ...
      titleSkills: 'Skills',
      skill1: 'Facebook Ads (Meta Suite)',
      skill2: 'TikTok Ads',
      skill3: 'CRM: Salesforce',
      skill4: 'CRM: SAP',
      skill5: 'CRM: Teamtailor',
      skill6: 'Google Business Tools',
      skill7: 'Microsoft Business Tools',
      skill8: 'Adobe Creative Cloud',
      skill9: 'B2B Communication',
      skill10: 'Process Optimization',
    ...
    de: {
      ...
      skill7: 'Microsoft Business Tools',
      skill8: 'Adobe Creative Cloud',
      skill9: 'B2B-Kommunikation',
      skill10: 'Prozessoptimierung',
    ...
    it: {
      ...
      skill7: 'Microsoft Business Tools',
      skill8: 'Adobe Creative Cloud',
      skill9: 'Comunicazione B2B',
      skill10: 'Ottimizzazione dei processi',
    ...
    es: {
      ...
      skill7: 'Microsoft Business Tools',
      skill8: 'Adobe Creative Cloud',
      skill9: 'Comunicación B2B',
      skill10: 'Optimización de procesos',
    ...
    fr: {
      ...
      skill7: 'Microsoft Business Tools',
      skill8: 'Adobe Creative Cloud',
      skill9: 'Communication B2B',
      skill10: 'Optimisation des processus',
